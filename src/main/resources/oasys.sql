...
CREATE TABLE `aoa_attends_list`  (
  `attends_id` bigint(0) NOT NULL AUTO_INCREMENT,
  `attends_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `attends_remark` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `attends_time` datetime(0) NULL DEFAULT NULL,
  `status_id` bigint(0) NULL DEFAULT NULL,
  `type_id` bigint(0) NULL DEFAULT NULL,
  `attends_user_id` bigint(0) NULL DEFAULT NULL,
  `attend_hmtime` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `week_ofday` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
INSERT INTO `aoa_attends_list` VALUES (49, '192.168.0.101', NULL, '2020-06-10 03:17:06', 11, 8, 5, '11:17', '星期三', NULL, NULL);
INSERT INTO `aoa_attends_list` VALUES (50, '192.168.190.1', NULL, '2020-06-10 03:52:19', 12, 9, 5, '11:52', '星期三', NULL, NULL);
INSERT INTO `aoa_attends_list` VALUES (51, '192.168.0.101', NULL, '2020-06-11 02:20:11', 11, 8, 5, '10:20', '星期四', NULL, NULL);
INSERT INTO `aoa_attends_list` VALUES (52, '192.168.0.101', NULL, '2020-06-11 03:42:24', 12, 9, 5, '11:42', '星期四', NULL, NULL);
...
CREATE TABLE `aoa_dept`  (
  ...
  `deptmanager` bigint(0) NULL DEFAULT NULL,
...
CREATE TABLE `aoa_file_list`  (
  ...
  `file_shuffix` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
INSERT INTO `aoa_file_list` VALUES (134, 'ppp.apk', '/2020/06/soli/b2764208-afbf-4329-b974-99a45dbb3020.apk', 'apk', 'application/octet-stream', NULL, 95, 6315184, '2020-06-11 03:17:53', 5, 0, 0);
INSERT INTO `aoa_file_list` VALUES (135, '新建文本文档.txt', '/2020/06/soli/c85098f6-9694-4dc7-855f-542ed72688bd.txt', 'txt', 'text/plain', NULL, 95, 22, '2020-06-11 03:18:02', 5, 0, 0);
INSERT INTO `aoa_file_list` VALUES (136, '新建文本文档(1).txt', '/2020/06/soli/30b80c0d-3b0a-4b3f-96dd-b644501cbc5e.txt', 'txt', 'text/plain', NULL, 95, 22, '2020-06-11 03:20:49', 5, 0, 0);
...
CREATE TABLE `aoa_file_path`  (
  `path_id` bigint(0) NOT NULL AUTO_INCREMENT,
  ...
  `path_user_id` bigint(0) NULL DEFAULT NULL,
  `path_istrash` bigint(0) NULL DEFAULT 0,
...
CREATE TABLE `aoa_position`  (
  ...
  `describtion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
INSERT INTO `aoa_position` VALUES (27, 32, '1221', 'edewqce', 2);
INSERT INTO `aoa_position` VALUES (28, 21, '11', 'sa', 1);
...
CREATE TABLE `aoa_role_`  (
  ...
  `role_value` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `aoa_schedule_list`  (
  `rc_id` bigint(0) NOT NULL AUTO_INCREMENT,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `end_time` datetime(0) NULL DEFAULT NULL,
  `filedescribe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `is_remind` int(0) NULL DEFAULT NULL,
  `start_time` datetime(0) NULL DEFAULT NULL,
  `status_id` bigint(0) NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `type_id` bigint(0) NULL DEFAULT NULL,
  `user_id` bigint(0) NULL DEFAULT NULL,
  `miaoshu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `isreminded` int(0) NULL DEFAULT NULL,
...
INSERT INTO `aoa_schedule_list` VALUES (12, '2020-06-10 03:38:35', '2020-06-11 03:38:18', NULL, 0, '2020-06-10 03:38:18', 27, 'wd22', 45, 5, '23e221312', 0);
INSERT INTO `aoa_schedule_list` VALUES (13, '2020-06-11 02:27:49', '2020-06-12 02:27:40', NULL, 0, '2020-06-11 02:27:40', 27, 'aa', 44, 5, '', 0);
INSERT INTO `aoa_schedule_list` VALUES (14, '2020-06-11 02:32:28', '2020-06-12 02:31:20', NULL, 0, '2020-06-11 02:31:20', 27, '', 44, 5, '121', 0);
INSERT INTO `aoa_schedule_list` VALUES (15, '2020-06-11 02:38:00', '2020-06-13 02:37:39', NULL, 0, '2020-06-12 02:37:39', 28, '1231', 45, 5, 'werewrqw', 0);
...
INSERT INTO `aoa_schedule_user` VALUES (12, 1);
INSERT INTO `aoa_schedule_user` VALUES (15, 2);
...
CREATE TABLE `aoa_status_list`  (
  `status_id` bigint(0) NOT NULL AUTO_INCREMENT,
  `status_color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `status_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `status_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `sort_value` int(0) NULL DEFAULT NULL,
  `sort_precent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE TABLE `aoa_sys_menu`  (
  ...
  `is_show` int(0) NULL DEFAULT NULL,
  `menu_grade` int(0) NULL DEFAULT NULL,
  ...
  `menu_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `parent_id` bigint(0) NULL DEFAULT NULL,
...
CREATE TABLE `aoa_task_list`  (
  ...
  `end_time` datetime(0) NULL DEFAULT NULL,
  `is_cancel` int(0) NULL DEFAULT 0,
  ...
  `task_describe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ticking` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `type_id` bigint(0) NULL DEFAULT NULL,
  `task_push_user_id` bigint(0) NULL DEFAULT NULL,
  `reciverlist` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE TABLE `aoa_task_logger`  (
  `logger_id` bigint(0) NOT NULL AUTO_INCREMENT,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `logger_ticking` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `task_id` bigint(0) NULL DEFAULT NULL,
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `logger_statusid` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `aoa_task_user`  (
  ...
  `status_id` bigint(0) NULL DEFAULT NULL,
  `task_id` bigint(0) NULL DEFAULT NULL,
  `task_recive_user_id` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`pk_id`) USING BTREE,
...
CREATE TABLE `aoa_type_list`  (
  `type_id` bigint(0) NOT NULL AUTO_INCREMENT,
  `type_color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `type_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE TABLE `aoa_user`  (
  ...
  `eamil` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `father_id` bigint(0) NULL DEFAULT NULL,
  `hire_time` datetime(0) NULL DEFAULT NULL,
  `user_idcard` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `user_school` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `sex` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `theme_skin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `user_edu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `role_id` bigint(0) NULL DEFAULT NULL,
  `superman` int(0) NULL DEFAULT NULL,
...
-- Records of aoa_user
-- ----------------------------
INSERT INTO `aoa_user` VALUES (1, '湖南工业大学', '62175555555555444', '1986-02-03 00:00:00', '1057@qq.com', 0, '2017-09-22 19:35:40', '510322198602030429', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '小明', 2000, '湖南工业大学', '男', 'blue', '本科', '罗密欧', '好好', '13272143450', 1, 1, 1, 1, NULL, 'luomiou');
...
INSERT INTO `aoa_user` VALUES (5, '中南大学', '7777', '1996-09-19 16:56:50', '173@126.com', 3, '2014-09-19 16:57:21', '432524199612188016', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '小罗', 4000, '中南大学', '男', 'blue', '博士', 'soli', 'iinteresting', '18173328976', 3, 5, 4, 0, NULL, 'soli');
...
INSERT INTO `aoa_user` VALUES (7, '湖南工业大学', '6666', '2017-10-01 15:20:20', '188@qq.com', 3, '2017-10-05 15:20:39', '432524199712188020', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '小喻', 5000, '湖南工业大学', '男', 'yellow', '本科', '甄姬', NULL, '13117336953', 5, 7, 4, 0, NULL, 'zhengji');
INSERT INTO `aoa_user` VALUES (8, '中国广东', '62175555555555444', '2017-10-04 15:20:20', '188@qq.com', 4, '2017-10-02 15:20:39', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '小费', 5000, '湖南工业大学', '女', 'red', '本科', '甄姬2', NULL, '13117336954', 2, 10, 5, 0, NULL, 'zhengji2');
INSERT INTO `aoa_user` VALUES (9, '中国广东', '5555444', '2017-10-03 14:23:10', '55@qq.com', 4, '2017-10-11 14:23:32', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '小花', 3111, '湖南工业大学', '女', 'blue', '本科', '甄嬛', NULL, '13034507214', 2, 11, 5, 0, NULL, 'zhenghuan');
INSERT INTO `aoa_user` VALUES (10, '清华大学', '4444', '2017-10-18 14:26:17', '66@qq.com', 4, '2017-10-07 14:26:37', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '花红', 2555, '湖大', '女', 'green', '本科', '无双', NULL, '13117336954', 2, 12, 5, 0, NULL, 'wushuang');
INSERT INTO `aoa_user` VALUES (11, '中南大学', '6666', '2017-10-07 14:27:54', '1057@qq.com', 4, '2017-10-07 14:28:06', '5824566822688', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '兰瑞', 5000, '中南', '男', 'yellow', '硕士', '瑞王', NULL, '13117336953', 2, 13, 5, 0, NULL, 'ruiwang');
...
INSERT INTO `aoa_user` VALUES (14, '中国广东', '123478', '1995-03-05 00:00:00', '164@qq.com', 5, '2017-10-05 15:20:39', '510322199503052485', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '黑椰', 1000, '湖南大学', '女', 'green', '硕士', '盛如思', NULL, '18868688866', 3, 21, 5, 0, NULL, 'shengrusi');
INSERT INTO `aoa_user` VALUES (15, '中国广东', '6666', '1994-09-19 16:52:11', '173@126.com', 5, '2017-10-02 15:20:39', '432524199612188018', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '车寿山', 3000, '清华大学', '男', 'yellow', '硕士', '李楚堂', NULL, '13117336953', 3, 22, 5, 0, NULL, 'lichutang');
INSERT INTO `aoa_user` VALUES (16, '清华大学', '7777', '1996-09-19 16:56:50', '188@qq.com', 5, '2017-10-11 14:23:32', '432524199612188016', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '白秋生', 4000, '中南大学', '男', 'red', '博士', '支晓璇', NULL, '13117336954', 3, 23, 5, 0, NULL, 'zhixiaoxuan');
INSERT INTO `aoa_user` VALUES (17, '中南大学', '9999', '1997-09-19 16:59:29', '188@qq.com', 6, '2017-10-07 14:26:37', '432524199712188019', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '饶子和', 3700, '上海交大', '女', 'blue', '本科', '薛邵琴', NULL, '13034507214', 4, 16, 5, 0, NULL, 'xueshanqin');
INSERT INTO `aoa_user` VALUES (18, '泰山西路', '6666', '2017-10-01 15:20:20', '188@qq.com', 6, '2017-10-07 14:28:06', '432524199712188020', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '王秋阳', 5000, '湖南工业大学', '男', 'green', '本科', '光宇', NULL, '13117336954', 4, 17, 5, 0, NULL, 'guangyu');
INSERT INTO `aoa_user` VALUES (19, '湖南工业大学', '62175555555555444', '2017-10-04 15:20:20', '55@qq.com', 6, '2014-09-19 16:57:21', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '叶知秋', 5000, '湖南工业大学', '女', 'yellow', '本科', '朱茵', NULL, '13117336953', 4, 18, 5, 0, NULL, 'zhuyin');
INSERT INTO `aoa_user` VALUES (20, '中国广东', '5555444', '2017-10-03 14:23:10', '66@qq.com', 6, '2014-09-19 16:57:21', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '刘湛秋', 3111, '湖南工业大学', '女', 'red', '本科', '朱颖', NULL, '13117336953', 4, 19, 5, 0, NULL, 'zhuyin');
INSERT INTO `aoa_user` VALUES (21, '中国广东', '4444', '2017-10-18 14:26:17', '88@qq.com', 6, '2014-09-19 16:57:21', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '李发友', 2555, '湖大', '女', 'blue', '本科', '杨晓木', NULL, '18868688866', 4, 20, 5, 0, NULL, 'yangxiaomu');
INSERT INTO `aoa_user` VALUES (22, '清华大学', '6666', '2017-10-07 14:27:54', '1057@qq.com', 7, '2014-09-19 16:57:21', '5824566822688', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '金燕西', 5000, '中南', '男', 'green', '硕士', '陈晓吉', NULL, '13117336953', 5, 8, 5, 0, NULL, 'chenxiaoji');
...
INSERT INTO `aoa_user` VALUES (25, '湖南工业大学', '62175555555555444', '2017-10-04 15:20:20', '55@qq.com', 6, '2014-09-19 16:57:21', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '张秋', 5000, '湖南工业大学', '女', 'yellow', '本科', '张秋', NULL, '13117336953', 4, 18, 5, 0, NULL, 'zhangqiu');
INSERT INTO `aoa_user` VALUES (26, '清华大学', '7777', '1996-09-19 16:56:50', '188@qq.com', 5, '2017-10-11 14:23:32', '432524199612188016', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '张秋生', 4000, '中南大学', '男', 'red', '博士', '张秋生', NULL, '13117336954', 3, 23, 5, 0, NULL, 'zhangqiusheng');
INSERT INTO `aoa_user` VALUES (27, '中国广东', '4444', '2017-10-18 14:26:17', '88@qq.com', 6, '2014-09-19 16:57:21', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '张宇', 2555, '湖大', '女', 'blue', '本科', '张宇', NULL, '18868688866', 4, 20, 5, 0, NULL, 'zhangyu');
INSERT INTO `aoa_user` VALUES (28, '中国广东', '55555', '2017-10-14 21:51:42', '55@qq.com', 4, '2017-10-14 21:52:15', '432524199712188021', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '薛之谦', 222, '湖大', '男', 'blue', '硕士', '上上签', NULL, '18868688866', 2, 10, 6, 0, NULL, 'shangshangqian');
INSERT INTO `aoa_user` VALUES (35, 'wqasd', '6217002940101998752', '2017-10-16 00:00:00', 'qq@qq.com', NULL, '2017-10-16 00:00:00', '430602199501121115', 'oasys.jpg', 0, NULL, NULL, NULL, NULL, '123456', '总金办测试用户', 123213, 'asdas', '男', 'blue', 'qwewq', 'wuianan', NULL, '13600003532', 1, 2, 5, 0, NULL, NULL);
...
INSERT INTO `aoa_user_login_record` VALUES (114, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 10:35:48', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (115, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 10:51:27', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (116, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 10:53:36', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (117, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:12:32', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (118, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:16:25', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (119, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:19:51', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (120, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:21:49', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (121, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:33:51', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (122, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:34:56', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (123, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:41:28', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (124, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:42:32', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (125, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 11:44:07', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (126, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:00:59', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (127, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:06:49', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (128, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:13:24', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (129, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:17:13', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (130, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:18:24', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (131, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:19:48', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (132, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:20:58', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (133, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:40:07', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (134, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:49:23', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (135, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:50:54', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (136, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 12:57:57', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (137, 'Firefox 7/76.0', '192.168.190.1', '2020-06-09 13:12:36', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (138, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:18:09', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (139, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:20:34', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (140, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:34:28', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (141, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:41:07', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (142, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:42:34', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (143, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 01:45:32', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (144, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:47:29', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (145, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 01:50:53', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (146, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:52:26', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (147, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 01:58:23', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (148, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:03:06', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (149, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 02:04:26', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (150, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 02:09:42', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (151, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:19:24', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (152, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:20:27', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (153, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 02:23:38', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (154, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:26:44', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (155, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:27:51', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (156, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:28:56', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (157, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:31:26', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (158, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:34:03', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (159, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:38:53', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (160, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 02:41:12', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (161, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 02:46:30', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (162, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 03:04:22', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (163, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 03:16:55', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (164, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 03:24:22', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (165, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 03:25:59', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (166, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 03:34:34', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (167, 'Firefox 7/76.0', '192.168.190.1', '2020-06-10 03:35:25', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (168, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 03:51:37', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (169, 'Firefox 7/76.0', '192.168.0.101', '2020-06-10 13:47:39', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (170, 'Firefox 7/76.0', '192.168.190.1', '2020-06-11 02:12:29', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (171, 'Firefox 7/76.0', '192.168.190.1', '2020-06-11 02:18:29', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (172, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:19:50', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (173, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:22:53', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (174, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:24:15', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (175, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:30:33', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (176, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:33:29', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (177, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:37:33', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (178, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:45:39', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (179, 'Firefox 7/76.0', '192.168.190.1', '2020-06-11 02:55:29', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (180, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 02:58:20', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (181, 'Firefox 7/76.0', '192.168.190.1', '2020-06-11 03:01:30', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (182, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 03:09:46', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (183, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 03:13:07', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (184, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 03:17:45', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (185, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 03:20:36', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (186, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 03:30:08', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (187, 'Firefox 7/76.0', '192.168.190.1', '2020-06-11 03:31:08', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (188, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 03:42:20', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (189, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 04:07:10', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (190, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 04:08:41', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (191, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 04:10:13', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (192, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 06:24:43', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (193, 'Firefox 7/76.0', '192.168.0.101', '2020-06-11 06:29:48', NULL, 5);
INSERT INTO `aoa_user_login_record` VALUES (194, 'Firefox 7/77.0', '192.168.0.101', '2020-06-12 01:21:46', NULL, 5);
